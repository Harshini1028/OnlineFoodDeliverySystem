...
<body>
    ...
    <div id="about" class="section-content">
        <h2>About Us</h2>
        <p>We are a passionate team committed to bringing the best local restaurants and cuisines closer to you through a fast, reliable, 
        and easy-to-use online food delivery platform. Whether you're craving a hearty biryani, spicy street food, or a comforting dessert — we've got it all, just a click away.</p>
    </div>

    <div id="contact" class="section-content">
        <h2>Contact Us</h2>
        <p>Email: harshinimokkapati@gmail.com<br>Phone: +91 9876543210<br>Address: vijayawada,opp siddhartha pharmacy college <br>vijayawada,India</p>
    </div>
